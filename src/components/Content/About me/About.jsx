...
import SkillFrame from "../../../UI/SkillFrame";
    ...
    return (
        <section className={classes.section}>
            <div className={classes.container}>
                ...
                <p className={classes.description}>Here you will find more information about me, what I do, and my current skills mostly <br />
